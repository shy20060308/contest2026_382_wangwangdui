...
Object.keys(manifest.router.pages || {}).forEach(route => {
  ...
  assert.ok(!dependsOn(source, '/design/specs/') && !dependsOn(source, '/design/views/'), relative + ' must import authoritative app-owned Design modules directly')
...
const clockDesign = read('src/v2/design/apps/clock/layout.js')
...
assert.ok(clock.includes("../../v2/design/apps/clock") && clock.includes("../../v2/design/apps/clock/view"), 'Clock must bind Feature state through Design')
assert.ok(clock.includes("../../v2/design/apps/notification/view"), 'Clock and notification demo must share notification Design projection')
...
assert.ok(notification.includes("../../v2/features/notification/controller") && notification.includes("../../v2/design/apps/notification/view"), 'notification demo must share semantic Feature and Design projection with Clock')
assert.ok(workout.includes("../../v2/features/workout/controller") && workout.includes("../../v2/design/apps/workout/view"), 'Workout Page must bind semantic Feature state through Design View')
...
assert.ok(workoutSelection.includes("../../v2/design/apps/workout/selection") && workoutSelection.includes("../../v2/design/apps/workout/selection_view"), 'Workout Selection must be Design Engine driven')
assert.ok(workoutHistory.includes("../../v2/design/apps/workout/history_view"), 'Workout History must format records in Design View')

assert.ok(launcher.includes("../../v2/features/launcher/controller") && launcher.includes("../../v2/design/apps/launcher/view") && launcher.includes("../../v2/design/engines/honeycomb"), 'Launcher must use semantic Feature plus V2 Design View/Engine')
...
assert.ok(selector.includes("../../v2/features/watchface/controller") && selector.includes("../../v2/design/apps/faces/view"), 'Watchface selection must separate semantic Feature and visual Design View')
assert.ok(settings.includes("../../../v2/design/apps/settings") && settings.includes("../../../v2/design/apps/settings/view"), 'Settings menu must be a pure L1 Design surface')
