...
assert.ok(today.includes("../../v2/features/today/controller") && !today.includes("../../domain/activity/store"), 'Pending Today Page must still consume Activity through its Feature orchestration')

console.log('Activity persistence verified: truthful totals, one async hydration source, live subscriptions and JSON-owned Steps presentation (' + passed + ' runtime tests)')
