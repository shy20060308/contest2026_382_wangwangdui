...
assert.ok(repository.includes("../../capabilities/storage"), 'activity repository must persist through capability storage')
assert.ok(!repository.includes('platform/vela'), 'activity domain must not depend on legacy platform adapters')
