...
assert.ok(steps.includes('surface_host.ux') && steps.includes("var surface = require('../../product/frontend/surfaces/steps.json')") && steps.includes("import controllerBinding from '../../product/controller_bindings/activity'") && steps.includes('surfacePage.bind(this, surface, controllerBinding)'), 'Steps Page must be a thin page-local declarative Surface host with only the Activity binding')
...
assert.strictEqual(stepsSurface.controller, 'activity', 'Steps JSON must bind the page-local Activity controller')
...
assert.ok(today.includes('surface_host.ux') && today.includes("var surface = require('../../product/frontend/surfaces/today.json')") && today.includes("import controllerBinding from '../../product/controller_bindings/today'") && today.includes('surfacePage.bind(this, surface, controllerBinding)'), 'Today Page must be a thin page-local declarative Surface host with only the Today binding')
