...
const activityView = require('../src/v2/design/apps/steps/view')
const motionView = require('../src/v2/design/apps/motion/view')
const syncView = require('../src/v2/design/apps/sync/view')
const notificationView = require('../src/v2/design/apps/notification/view')
const vibrationView = require('../src/v2/design/apps/vibration/view')
const historyView = require('../src/v2/design/apps/history/view')
