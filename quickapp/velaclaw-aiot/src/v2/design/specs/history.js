...
function resolve(profile, scene, safe) {
  ...
  plan.chartHeight = plan.trendMode === 'comparative-row' ? 10 : Math.round(40 * Math.min(scale, 1.4))
  ...
  plan.trendHeight = plan.trendMode === 'comparative-row' ? Math.round(182 * Math.min(scale, 1.12)) : Math.round(78 * scale)
