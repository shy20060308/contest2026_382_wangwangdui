...
var mockTick = 0
var values = { heartRate: 88, spo2: 97, stress: 28 }
var live = { heartRate: false, spo2: false, stress: false }
var errorCodes = { heartRate: 0, spo2: 0, stress: 0 }
var updatedAt = 0
var metricUpdatedAt = { heartRate: 0, spo2: 0, stress: 0 }
...
function emit() {
  ...
  for (var i = 0; i < current.length; i++) current[i](data)
}
