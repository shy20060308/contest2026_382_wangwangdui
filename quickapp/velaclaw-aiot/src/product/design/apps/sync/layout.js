module.exports = {
  base: {
    ...
    chrome: {
      ...
      actionRowHeight: 36, actionWidth: '48%', actionHeight: 34, actionRadius: 13, actionSize: 11,
      syncMinHeight: 100, cardTitleSize: 10, syncPercentSize: 10,
      trackHeight: 6, trackRadius: 3, trackMarginTop: 9, fillHeight: 6, fillRadius: 3,
      messageSize: 8, messageMarginTop: 9, packetSize: 7, packetMarginTop: 4,
      dataMinHeight: 94, dataLineSize: 8, dataLineMarginTop: 7,
      tipSize: 6, tipLineHeight: 9, tipMarginTop: 8, tipMarginBottom: 10
    }
  },
  circle: {
